...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="'+classes.sFilterInput+'" onkeydown="return KeyBoardDown(event);" onkeypress="return KeyBoardPress(event);"/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "দেখাচ্ছে _START_ থেকে _END_ এর _TOTAL_ লিখন",
			 ...
			 *    } );
			 */
			"sLengthMenu": "প্রদর্শন _MENU_ লিখন",
			 ...
			 *    } );
			 */
			"sZeroRecords": "মিলে যাওয়া কোন নথি খুঁজে পাওয়া যায় নি"
		},
