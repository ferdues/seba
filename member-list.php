...
<html>
  <head>
    <meta charset="UTF-8">
    <title>সভ্যগনের তালিকা || <?php echo COMPANY_NAME; ?></title>
...
<h2 style="text-align:center;"><?php echo COMPANY_NAME; ?></h2> 
     ...
     <!--p style="text-align:center; font-size:75%;">Email: <?php echo COMPANY_EMAIL;?></p-->
      <h1 style="text-align:center; border:1px black solid; font-size:18px;">সভ্যগনের তালিকা</h1>
</header>
...
$query = "SELECT * FROM `MemberCreate` inner join AreaCreate on MemberCreate.AreaCode=AreaCreate.AreaCode order by MemberCreate.MemberID ASC";
$result = mysqli_query($mysqli, $query);

// mysqli select query
if($result) {
	while ($row = mysqli_fetch_assoc($result)) {
		echo "<tr><td style='text-align:center;'>" . bang_num($row['MemberID']) . "</td>";
